...
class _MyHomePageState extends State<MyHomePage> {
  ...
  ThemeData _customTheme = ThemeData(primaryColor: Color((Random().nextDouble() * 0xFFFFFF).toInt()).withOpacity(1.0), accentColor: Color((Random().nextDouble() * 0xFFFFFF).toInt()).withOpacity(1.0), backgroundColor: Colors.white);
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 8),
            _themeColorContainer("Primary Color", Theme.of(context).primaryColor),
            ...
            Expanded(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  Expanded(flex: 5, child: ThemeButton(buttonThemeData: _customTheme)),
                  Expanded(
                    flex: 5,
                    child: Column(
                      children: <Widget>[
  ...
  Widget _themeColorContainer(String colorName, Color color) {
    return Container(
      ...
      color: color,
      child: Text(colorName, textAlign: TextAlign.center, style: Theme.of(context).primaryTextTheme.button),
    );
  }
        ...
        return AlertDialog(
          ...
          content: Container(
            ...
            child: MaterialColorPicker(
              ...
              onColorChange: (color) => setState(() => _customTheme = (primaryColor) ? _customTheme.copyWith(primaryColor: color) : _customTheme.copyWith(accentColor: color)),
              onMainColorChange: (color) => setState(() => _customTheme = (primaryColor) ? _customTheme.copyWith(primaryColor: color) : _customTheme.copyWith(accentColor: color)),
            ),
          ),
          actions: <Widget>[
            TextButton(
