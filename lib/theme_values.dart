...
final blueTheme = ThemeData(primaryColor: bluePrimary, accentColor: blueAccent, backgroundColor: blueBackground);
...
final greenTheme = ThemeData(primaryColor: greenPrimary, accentColor: greenAccent, backgroundColor: greenBackground);

/// ----  Pink Theme  ----
final pinkPrimary = Color(0xFFE91E63);
final pinkAccent = Color(0xFF0C7D9C);
final pinkBackground = Color(0xFFFFFFFF);
final pinkTheme = ThemeData(primaryColor: pinkPrimary, accentColor: pinkAccent, backgroundColor: pinkBackground);
